...
-- =====================================================
-- ACADEMICS UPGRADE: removed attendance-related sections
-- (No attendance tables, no ALTER for attendance columns)
-- =====================================================

-- Note: All attendance tables, indexes, and related ALTER statements
-- have been removed from this script as per instructions.
