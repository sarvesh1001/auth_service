...
type ReturnItem struct {
	...
	Quantity            decimal.Decimal `gorm:"type:numeric(14,4);not null;check:quantity > 0" json:"quantity"` // fixed typo
	...
	CreatedBy           *uuid.UUID      `gorm:"type:uuid" json:"createdBy,omitempty"` // added
}
