// internal/service/session_service.go - UPDATED WITH ACCESS TOKEN STORAGE
package service
...
// IssueTokenPairRequest for JWT token pair issuance
...
func (s *SessionService) IssueTokenPair(ctx context.Context, req *IssueTokenPairRequest) (*models.TokenPairResponse, error) {
    ...
    // ---------------------------------------------------------
    s.logger.Info("Token pair issued with company context",
        util.String("user_id", req.UserID),
...
//     SessionType      string
//     IPAddress        string
//     CompanyID        string // ✅ ADDED: Company ID for context
//     AdminRoleLevel   string
//     AdminPermissions []string
// }
...
//         DeviceID:         req.DeviceID,
//         SessionType:      req.SessionType,
//         CompanyID:        req.CompanyID, // ✅ INCLUDED
//         AdminRoleLevel:   req.AdminRoleLevel,
//         AdminPermissions: req.AdminPermissions,
//     })
//     if err != nil {
...
//     // ---------------------------------------------------------
//     // 4️⃣ Store refresh token in Redis WITH CompanyID
//     // ---------------------------------------------------------
//     now := time.Now().UTC()
...
//         DeviceID:         req.DeviceID,
//         SessionType:      req.SessionType,
//         CompanyID:        req.CompanyID, // ✅ STORE COMPANY ID
//         IssuedAt:         now,
//         ExpiresAt:        now.Add(s.config.JWT.RefreshTTL),
//         LastUsed:         now,
//         Revoked:          false,
...
//     // ---------------------------------------------------------
//     // 5️⃣ Log token issuance with CompanyID
//     // ---------------------------------------------------------
//     s.logger.Info("Token pair issued with company context",
//         util.String("user_id", req.UserID),
//         util.String("session_type", req.SessionType),
...
//         ExpiresIn:    int(s.config.JWT.AccessTTL.Seconds()),
//         TokenType:    "Bearer",
//         CompanyID:    req.CompanyID, // ✅ INCLUDE IN RESPONSE
//     }, nil
// }
...
//     if err := s.sessionRepo.RevokeAllUserRefreshTokens(ctx, userID); err != nil {
