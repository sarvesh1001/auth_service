...
// 	// Core single-user ops
// 	CreateUser(ctx context.Context, user *models.User) error
// 	GetUserByID(ctx context.Context, userID uuid.UUID) (*models.User, error)
// 	GetUserByPhoneHash(ctx context.Context, phoneHash string) (*models.User, error)
// 	GetUsersByPhoneHashIndex(ctx context.Context, phoneHash string, limit int) ([]*models.User, error)
...
// 	// Company operations (role management moved to company_employees table)
// 	UpdateUserCompany(ctx context.Context, userID uuid.UUID, companyID uuid.UUID) error
// 	GetUsersByCompany(ctx context.Context, companyID uuid.UUID, limit int) ([]*models.User, error)
...
// 	// UpdateUserCompanyAndRole(ctx context.Context, userID uuid.UUID, companyID uuid.UUID, roleLevel string) error
// }
...
type UserRepository interface {
    ...
    HealthCheck(ctx context.Context) error
    GetRepositoryStats(ctx context.Context) (map[string]interface{}, error)
    // ❌ REMOVED: UpdateUserCompanyAndRole(ctx context.Context, userID uuid.UUID, companyID uuid.UUID, roleLevel string) error
}